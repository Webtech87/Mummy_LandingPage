   ...
   useEffect(() => {
    const fetchFormData = async () => {
      try {
        ...
        // Инициализируем начальные значения формы
        const initialValues = {};
        Object.entries(response.data.form_structure.fields).forEach(([key, field]) => {
          initialValues[key] = field.initial ?? (field.type === 'checkbox' ? false : '');
        });
