...
const Navbar = () => {
    ...
    return (
        <nav ref={navbarRef} className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`} aria-label="Main navigation">
